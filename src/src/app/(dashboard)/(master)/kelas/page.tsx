...
import { useClass } from "@/src/app/(dashboard)/(master)/kelas/hooks/useClass";
import { ClassData } from "@/src/app/(dashboard)/(master)/kelas/types";
import { ClassTable } from "@/src/app/(dashboard)/(master)/kelas/components/ClassTable";
