import {QuestionRecord, CodeFormData, EssayFormData} from "../types";
import { CourseRecord, LessonRecord, SubLessonRecord } from "@/src/app/(dashboard)/(master)/course/types";
