    ...
    >
      ...
      <Row gutter={[24, 24]}>
        <Col xs={24} md={16}>
            ...
            <Row gutter={[12, 12]} style={{ marginBottom: "20px" }}>
              <Col xs={24} sm={8}>
                <motion.div whileHover={{ y: -4 }} transition={{ type: "spring", stiffness: 300 }}>
                  <Card variant="borderless" style={{ borderRadius: "12px", background: "linear-gradient(145deg, #ffffff, #f0f5ff)", boxShadow: "0 4px 12px rgba(47, 84, 235, 0.05)" }} styles={{ body: { padding: "16px" } }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Text type="secondary" style={{ fontSize: "13px", fontWeight: 500, color: "#595959" }}>Enrolled Course</Text>
                        <div style={{ backgroundColor: "#D6E4FF", padding: "8px", borderRadius: "8px", color: "#2F54EB" }}>
                            <BookOutlined />
                        </div>
                    </div>
                    <Title level={3} style={{ margin: "12px 0 0", fontWeight: 800, color: "#1D39C4" }}>
              ...
              <Col xs={24} sm={8}>
                <motion.div whileHover={{ y: -4 }} transition={{ type: "spring", stiffness: 300 }}>
                  <Card variant="borderless" style={{ borderRadius: "12px", background: "linear-gradient(145deg, #ffffff, #fff0f6)", boxShadow: "0 4px 12px rgba(235, 47, 150, 0.05)" }} styles={{ body: { padding: "16px" } }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Text type="secondary" style={{ fontSize: "13px", fontWeight: 500, color: "#595959" }}>Materials Done</Text>
                        <div style={{ backgroundColor: "#FFD8BF", padding: "8px", borderRadius: "8px", color: "#FA541C" }}>
                            <FireFilled />
                        </div>
                    </div>
                    <Title level={3} style={{ margin: "12px 0 0", fontWeight: 800, color: "#C41D7F" }}>
              ...
              <Col xs={24} sm={8}>
                <motion.div whileHover={{ y: -4 }} transition={{ type: "spring", stiffness: 300 }}>
                  <Card variant="borderless" style={{ borderRadius: "12px", background: "linear-gradient(145deg, #ffffff, #e6fffb)", boxShadow: "0 4px 12px rgba(19, 194, 194, 0.05)" }} styles={{ body: { padding: "16px" } }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: "12px" }}>
                        <Text type="secondary" style={{ fontSize: "13px", fontWeight: 500, color: "#595959" }}>Overall Progress</Text>
                        <div style={{ backgroundColor: "#B5F5EC", padding: "8px", borderRadius: "8px", color: "#08979C" }}>
                            <ClockCircleOutlined />
                        </div>
                    </div>
                    <Progress percent={data?.overallProgress || 0} strokeColor="#13C2C2" railColor="#E6FFFB" />
                  </Card>
                </motion.div>
              </Col>
            </Row>
          ...
          {/* Lesson History */}
          <motion.div variants={itemVariants} style={{ display: 'flex', alignItems: 'center', marginBottom: "12px", gap: "8px" }}>
                          ...
                          <Row gutter={24} align="middle">
                              <Col xs={24} sm={8}>
                                  {history.course?.img_thumbnail ? (
                                     ...
                                     <div style={{ width: '100%', height: '120px', background: 'linear-gradient(135deg, #F093FB 0%, #F5576C 100%)', borderRadius: '12px', marginBottom: '12px' }} />
                                  )}
                              </Col>
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                  ...
                  <div>
                    ...
                    <Text style={{ fontSize: "13px", color: "rgba(255,255,255,0.8)" }}>Kamu luar biasa! Pertahankan.</Text>
                  </div>
                </div>
                <Row gutter={12}>
                    <Col span={8}>
                        <div style={{ background: "rgba(255,255,255,0.15)", padding: "16px 8px", borderRadius: "12px", textAlign: "center", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.2)" }}>
                            <Text style={{ color: "rgba(255,255,255,0.9)", fontSize: "11px", display: 'block', marginBottom: '4px', textTransform: "uppercase", letterSpacing: "0.5px" }}>Badge</Text>
                            <Text style={{ color: "#fff", fontWeight: 800, fontSize: "14px" }}>{data?.achievement?.badge || "-"}</Text>
                        </div>
                    </Col>
                    <Col span={8}>
                        <div style={{ background: "rgba(255,255,255,0.15)", padding: "16px 8px", borderRadius: "12px", textAlign: "center", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.2)" }}>
                            <Text style={{ color: "rgba(255,255,255,0.9)", fontSize: "11px", display: 'block', marginBottom: '4px', textTransform: "uppercase", letterSpacing: "0.5px" }}>Rank</Text>
                            <Text style={{ color: "#fff", fontWeight: 800, fontSize: "14px" }}>{data?.achievement?.rank || "-"}</Text>
                        </div>
                    </Col>
                    <Col span={8}>
                        <div style={{ background: "rgba(255,255,255,0.15)", padding: "16px 8px", borderRadius: "12px", textAlign: "center", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.2)" }}>
                            <Text style={{ color: "rgba(255,255,255,0.9)", fontSize: "11px", display: 'block', marginBottom: '4px', textTransform: "uppercase", letterSpacing: "0.5px" }}>Score</Text>
                            <Text style={{ color: "#fff", fontWeight: 800, fontSize: "14px" }}>{data?.achievement?.totalScore || "0"}</Text>
                        </div>
                    </Col>
                </Row>
            </Card>
