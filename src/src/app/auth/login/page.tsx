  ...
  const handleLogin = (values: LoginValues) => {
    ...
    setTimeout(() => {
      if (email === "admin@gmail.com" && password === "admin123") {
        ...
        router.push("/dashboard/master/level");
      } else if (email.includes("teacher")) {
        message.success("Login berhasil sebagai Pengajar!");
        router.push("/pengajar/dashboard"); // Route dummy pengajar
      } else {
        message.success("Login berhasil sebagai Siswa!");
        router.push("/student/dashboard"); // Route dummy siswa
      }
      setLoading(false);
    }, 1000);
  };
